    ...
    public class ParametrosController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            byte? idparametro = 0;
                ...
                if (par > 0)
                {
                    return RedirectToAction("Details/" + idparametro, "Parametros");
                }
                else
                {
        ...
        public ActionResult Create([Bind(Include = "par_Id,par_NombreEmpresa,par_TelefonoEmpresa,par_CorreoEmpresa,par_Emisor,par_Password,par_Mensaje,par_Asunto,par_Destinatario,par_Servidor,par_Puerto,par_PathLogo")] tbParametro tbParametro,
            ...
            )
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    var MsjError = "";
                    List = db.UDP_Gral_tbParametro_Insert(tbParametro.par_NombreEmpresa, tbParametro.par_TelefonoEmpresa, tbParametro.par_CorreoEmpresa, tbParametro.par_Emisor, tbParametro.par_Password, tbParametro.par_Mensaje, tbParametro.par_Asunto, tbParametro.par_Destinatario, tbParametro.par_Servidor, tbParametro.par_Puerto, tbParametro.par_PathLogo
                        );
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(byte? id,[Bind(Include = "par_Id,par_NombreEmpresa,par_TelefonoEmpresa,par_CorreoEmpresa,par_Emisor,par_Password,par_Mensaje,par_Asunto,par_Destinatario,par_Servidor,par_Puerto,par_PathLogo")] tbParametro tbParametro,
             HttpPostedFileBase FotoPath)

        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    IEnumerable<object> List = null;
                    var MsjError = "";
                    List = db.UDP_Gral_tbParametro_Update(tbParametro.par_Id, tbParametro.par_NombreEmpresa, tbParametro.par_TelefonoEmpresa, tbParametro.par_CorreoEmpresa, tbParametro.par_Emisor, tbParametro.par_Password, tbParametro.par_Mensaje, tbParametro.par_Asunto, tbParametro.par_Destinatario, tbParametro.par_Servidor, tbParametro.par_Puerto, tbParametro.par_PathLogo);
